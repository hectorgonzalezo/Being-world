...
def setInitNames():
    ...
    for finger in fingers:
        for coordinate in coordinates:
            names_array.append("%s_%s" % (finger, coordinate))
    
    names_array.extend(['Pinch', 'Grab'])
...
class SampleListener(Leap.Listener):
    ...
    def on_frame(self, controller):
        ...
        for hand in frame.hands:
            ...
            oscmsg.append(vectorCoordinates(hand_pos[2]))#send palm position
            ...
            print "  pitch: %f degrees, roll: %f degrees, yaw: %f degrees" % hand_loc

            #oscmsg.append(tupleExtractor(hand_loc))
            ...
            # Get pinch
            pinch_grab = (hand.pinch_strength, hand.grab_strength)
            print "       Pinch: %d  Grab: %d" % pinch_grab

            oscmsg.append(tupleExtractor(pinch_grab))
        ...
        for tool in frame.tools:
            ...
            print "  Tool id: %d, position: %s, direction: %s" % tool_info

            #oscmsg.append(tupleExtractor(tool_info))
